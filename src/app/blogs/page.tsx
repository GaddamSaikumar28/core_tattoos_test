...
//         <div className="text-center max-w-3xl mx-auto mb-16">
//           <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-heading uppercase text-secondary mb-6">
//                 Explore <span className="text-primary">Our Topics</span>
//           </h1>
//           <p className="text-gray-600 text-lg">
//             Dive into the world of ink. Select a category below to read our latest articles, artist highlights, and essential aftercare guides.
...
//                       sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
//                       priority={index <= 2}
//                       className="object-cover group-hover:scale-105 group-hover:opacity-100 transition-all duration-500 opacity-80"
//                     />
//                     <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-4 py-1.5 rounded-full shadow-sm">
//                       <span className="text-xs font-bold text-secondary uppercase tracking-wider">Category</span>
//                     </div>
//                   </div>
//                   <div className="p-8 flex flex-col flex-grow">
//                     <h2 className="text-3xl font-bold text-secondary mb-3 group-hover:text-primary transition-colors">{blog.title}</h2>
//                     <p className="text-gray-600 mb-8 line-clamp-2 text-sm">{blog.seo?.description || `Explore all the latest posts and updates in the ${blog.title} category.`}</p>
//                     <div className="mt-auto">
